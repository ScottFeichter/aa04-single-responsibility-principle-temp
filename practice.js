...
let calculateTotalCost = (costOfPie, pieQuantity) => costOfPie * pieQuantity;

//------------------------------------------------------------------------------

// Print the total revenue calculated using the given profitMargin
let printTotalRevenue = (totalCost, profitMargin, option, pieQuantity) => {
  const revenue = totalCost * (profitMargin || option);
...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
  ...
  printTotalRevenue(totalCost, profitMargin, 1.2, pieQuantity);
}
